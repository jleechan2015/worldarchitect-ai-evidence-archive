# Evidence Summary: bq_path14_gameplay_streaming_proxy_e2e
...
- **Status:** ✅ PASS
- **Campaign ID:** `zXDOGgALmEJOUaGl96m8`

### EVIDENCE_SIGNATURE_GUARD
- **Status:** ✅ PASS

## Provenance Chain
- **Git HEAD:** `9f44c2ed029c6cd614a33d36907548aa0752024b`
- **Test Timestamp:** `2026-06-11T20:21:37.159399+00:00`
- **Server PID:** `65577`
...
| Git provenance | metadata.json | git_provenance.git_head = `9f44c2ed...` |

## Coverage Matrix

| Scenario | Status | Campaign ID |
|----------|--------|-------------|
| path14_gameplay_streaming_proxy | ✅ Pass | `zXDOGgAL...` |
...
**Proves**:
- Core logic and scenario validation for bq_path14_gameplay_streaming_proxy_e2e
