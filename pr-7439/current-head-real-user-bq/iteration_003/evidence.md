# Evidence Summary: bq_path14_real_user_e2e
...
### path14_real_user_gameplay_streaming_proxy
- **Status:** ✅ PASS
- **Campaign ID:** `Dyk7bFWyYyUYR6M1FlGR`

### EVIDENCE_SIGNATURE_GUARD
- **Status:** ✅ PASS

## Provenance Chain
- **Git HEAD:** `e8180f690f07d6ed71893925a3a12bed9381f45a`
- **Test Timestamp:** `2026-06-11T22:19:45.575908+00:00`
- **Server PID:** `58903`
...
| Git provenance | metadata.json | git_provenance.git_head = `e8180f69...` |

## Coverage Matrix

| Scenario | Status | Campaign ID |
|----------|--------|-------------|
| path14_real_user_gameplay_streaming_proxy | ✅ Pass | `Dyk7bFWy...` |
...
**Proves**:
- Core logic and scenario validation for bq_path14_real_user_e2e
