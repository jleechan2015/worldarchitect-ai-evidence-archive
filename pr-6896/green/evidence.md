...
- **Status:** ✅ PASS
- **Campaign ID:** `x8qocKPwJrs98qJSbFpW`

### EVIDENCE_SIGNATURE_GUARD
- **Status:** ✅ PASS

## Provenance Chain
- **Git HEAD:** `6352cca8380788231442be69c169e8f135a0950c`
- **Test Timestamp:** `2026-05-22T09:20:14.564008+00:00`
- **Server PID:** `94266`
...
| Git provenance | metadata.json | git_provenance.git_head = `6352cca8...` |

## Coverage Matrix

| Scenario | Status | Campaign ID |
|----------|--------|-------------|
| one_time_schema_migration_and_strict_post_migration_validation | ✅ Pass | `x8qocKPw...` |
