# PR #7022 Original Scene 73 Red Repro

This directory contains the real red repro for the original user-visible bug in PR #7022: old-turn/stale-input narrative contamination at Scene 73.
...
This proves the original red failure. It does not prove the current PR fixes it. A green run for this exact reproduced scenario is still required before PR #7022 can claim to fix the original old-scene/stale-input bug.
